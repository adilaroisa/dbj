...
const Login = ({ onLogin }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const errMsg = err.response?.data?.message || 'Gagal koneksi server';
    ...
    return (
        <div className="login-container">
            <div className="login-card">
                <h2>{isRegisterMode ? 'Daftar Admin' : 'Login Admin'}</h2>
                <p>Silakan masuk untuk mengelola database jurnal</p>
